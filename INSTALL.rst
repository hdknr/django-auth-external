========================================================================
** Authx ** Installation Instructions
========================================================================

This section contains information about 
how to download and install **Authx** in your system. 
...
To install **Authx** from soruce code, use the provided installation script::
...
the `source code repository`_ using ``pip``::
    ...
    pip install -e git+https://github.com/hdknr/django-auth-external.git#egg=authx

The above command will install the latest development release of **Authx**.
